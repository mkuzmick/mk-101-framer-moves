...
export default function Page() {
  ...
  return (
    <main className="flex flex-col md:flex-row">
      ...
      {/* <div className='w-full md:w-2/3 p-10 bg-white overflow-y-auto h-screen'> */}
      <div className="w-full bg-white p-20">
        <p>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquam nisi
          tempora ut magni, libero dicta reprehenderit facere facilis blanditiis
          officia atque tenetur! Pariatur, quia soluta dolore officia iste
          veritatis unde.
        </p>
        <p>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquam nisi
